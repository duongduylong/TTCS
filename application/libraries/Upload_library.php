...
class Upload_library
{
	...
	{
		// Kiểm tra xem khóa 'list_image' có tồn tại trong $_FILES không
		if (!isset($_FILES[$list_image])) {
			return array(); // hoặc xử lý lỗi theo yêu cầu của bạn
		}
